...
utknąłem w projekcie nie wiem czy przez TSa czy przez co xD 
Wysłano
a dobra jakiś problem z tym API mam 
Wysłano
nie do konca rozumiem jaki ja link mam podać 


Dobra z api był problem 
Wysłano
'https://restcountries.com/v3.1/all?fields=name,capital,region,population,area,borders,flags,cca3');
restcountries.com
Wysłano
a miałem tylko do all i stąd był bład, bo zdefiniowałem typescriptem czego oczekuje z API 
Wysłano
a pobierał wszystko co jest na tej stronie 
Wysłano
i dlatego wywalało błąd